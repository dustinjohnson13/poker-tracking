    ...
    def 'should parse a tournament session file correctly'() {
        ...
        def expectedHands = [
                new Hand(2365702372L, new Blinds(10L, 20L), [
                        new Seat(1, UTG, false, 150000L, 0L),
                        new Seat(8, UTG_1, true, 150000L, 0L),
                        new Seat(4, UTG_2, false, 150000L, 0L),
                        new Seat(6, UTG_3, false, 150000L, 0L),
                        new Seat(2, UTG_4, false, 150000L, 0L),
                        new Seat(5, UTG_5, false, 150000L, 0L),
                        new Seat(9, DEALER, false, 150000L, 0L),
                        new Seat(7, SMALL_BLIND, false, 150000L, 0L),
                        new Seat(3, BIG_BLIND, false, 150000L, 0L)
                ]),
                new Hand(2365710356L, new Blinds(15L, 30L), [
                        new Seat(1, SMALL_BLIND, false, 144000L, 0L),
                        new Seat(8, BIG_BLIND, true, 72200L, 0L),
                        new Seat(4, UTG, false, 139000L, 0L),
                        new Seat(6, UTG_1, false, 262100L, 0L),
                        new Seat(5, UTG_2, false, 147000L, 0L),
                        new Seat(9, UTG_3, false, 313000L, 0L),
                        new Seat(7, UTG_4, false, 140000L, 0L),
                        new Seat(3, DEALER, false, 132700L, 0L)
                ]),
                new Hand(2365711424L, new Blinds(15L, 30L), [
                        new Seat(1, DEALER, false, 142500L, 0L),
                        new Seat(8, SMALL_BLIND, true, 69200L, 0L),
                        new Seat(4, BIG_BLIND, false, 139000L, 0L),
                        new Seat(6, UTG, false, 259100L, 0L),
                        new Seat(5, UTG_1, false, 147000L, 0L),
                        new Seat(9, UTG_2, false, 313000L, 0L),
                        new Seat(7, UTG_3, false, 140000L, 0L),
                        new Seat(3, UTG_4, false, 140200L, 0L)
                ]),
                new Hand(2365740574L, new Blinds(100L, 200L), [
                        new Seat(8, SMALL_BLIND, true, 257400L, 0L),
                        new Seat(6, BIG_BLIND, false, 698600L, 0L),
                        new Seat(9, DEALER, false, 394000L, 0L)
                ])
